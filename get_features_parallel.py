...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Convert CIF files to XRD features')
    ...
    parser.add_argument('--feature', help='Output file name for CSV',default="XRD") #OFM, XRD
    parser.add_argument('--np', help='No.of processes',default=10) #OFM, XRD
